      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="relative mb-8">
            ...
            <svg className="w-64 h-64 transform -rotate-90">
              ...
              <circle
                ...
                strokeWidth="8"
                strokeDasharray={754}
                strokeDashoffset={isActive ? 754 - (754 * 0.4) : 754}
                strokeLinecap="round"
                stroke="currentColor"
                fill="transparent"
                r="120"
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-6xl font-mono font-bold text-white tracking-tighter">14:59</span>
              <span className="text-sm text-neutral-400 mt-2 uppercase tracking-widest">Focus Time</span>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button className="p-4 rounded-full bg-neutral-800 text-neutral-400 hover:text-white hover:bg-neutral-700 transition-colors">
              <RotateCcw size={24} />
            </button>
          </div>
        </motion.div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-mono text-orange-400">25 min</span>
                </div>
                <input 
                  type="range" 
                  min="5" 
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-mono text-blue-400">5 min</span>
                </div>
                <input 
                  type="range" 
                  min="1" 
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <label className="text-sm text-neutral-300">Long Break</label>
                  <span className="text-sm font-mono text-purple-400">15 min</span>
                </div>
                <input 
                  type="range" 
                  min="10" 
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <button 
                onClick={() => setSmartBreaks(!smartBreaks)}
